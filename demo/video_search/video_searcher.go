...
import (
	...
	"github.com/Orisun/radic/v2/demo/video_search/common"
	"github.com/Orisun/radic/v2/demo/video_search/filter"
	"github.com/Orisun/radic/v2/demo/video_search/recaller"
...
func (searcher *VideoSearcher) Recall(searchContext *common.VideoSearchContext) {
	...
	for _, recaller := range searcher.Recallers {
		go func(recaller Recaller) {
			...
			util.Log.Printf("recall %d talents by %s", len(result), rule)
